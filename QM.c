/*
 * Quine-McCluskey Method for 4-variable Boolean Function Minimization
 * Supports don't-care conditions
 * Full step-by-step output with Prime Implicant Chart and final SOP expression
 */
